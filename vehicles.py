...
If you need to edit something, you would need to edit it at every specific place put inheritance makes 
so you can just edit one spot and it passes to all areas
...
class Car(Automobile):
    def __init__(self, make, model, mileage, price, door_num):
        super().__init__(make, model, mileage, price)
        self.__door_num = door_num

    def set_door_num(self, door_num ):
        self.__door_num = door_num
